...
public class HomeWork {
    ...
    public static void main(String[] args) {
        ...
        var processors = List.of(new ProcessorThrowException(LocalDateTime::now),
                new LoggerProcessor(new ProcessorSwitchFields()));
        ...
        objectForMessage.setData(List.of("s1", "s2", "s3"));
        ...
        System.out.println(historyMessage.isPresent());
