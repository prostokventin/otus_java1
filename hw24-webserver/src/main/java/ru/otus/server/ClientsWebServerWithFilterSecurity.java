...
public class ClientsWebServerWithFilterSecurity implements ClientsWebServer {
    ...
    public ClientsWebServerWithFilterSecurity(int port,
    ...
    private ServletContextHandler createServletContextHandler() {
        ...
        servletContextHandler.addServlet(new ServletHolder(new ClientsApiServlet(dbServiceClient, templateProcessor)), "/api/client");
